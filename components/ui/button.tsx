  ...
  `relative overflow-hidden group/button inline-flex items-center justify-center duration-400 whitespace-nowrap font-bold rounded ring-offset-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50`,
  {
    variants: {
      variant: {
        ...
        "experience-outline":
          "exp-btn-outline rounded-full font-medium border border-exp-glow/40 bg-transparent text-exp-glow hover:-translate-y-0.5 hover:border-exp-glow hover:bg-exp-glow/10",
        "experience-outline-neutral":
          "exp-btn-outline-neutral rounded-full font-medium border border-white/40 bg-transparent text-white hover:-translate-y-0.5 hover:border-white hover:bg-white/10",
      },
      size: {
